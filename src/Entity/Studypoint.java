...
@NamedQueries({
    ...
    @NamedQuery(name = "Studypoint.findStudentScore", query = "SELECT s.score FROM Studypoint s WHERE s.student.id = :id"),
    @NamedQuery(name = "Studypoint.findTotalScore", query = "SELECT s.score FROM Studypoint s"),
...
public class Studypoint implements Serializable {
    ...
    public Studypoint(Integer score) {
        this.score = score;
    }
